...
const AdminSignInProvider = () => {
  ...
  async function sendRequest() {
    try {
        const url =  `${BACKEND_URL}/api/v1/admin/signin`;
    ...
    <>
      <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center flex-col items-center">
          <div className="text-3xl font-extrabold">Admin Sign In</div>
          <div>
...
export default AdminSignInProvider;
